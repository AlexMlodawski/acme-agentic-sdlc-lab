...
- Browser checks improve confidence but do not replace threat modeling, load testing, privacy review, or human acceptance.
- Repository checks cannot establish legal ownership of code or assets; maintainers must confirm it before publication.
