...
## 0.1.0 — validated local foundation

- zero-secret local portal and API;
- deterministic contextual assistant;
- strict contract, unit tests, build, and browser acceptance;
- optional Draft agent source package;
- evidence and claims model;
...
- validate the optional agent package in a separate, account-free CI job;
- add community-contributed scenarios without production data.
